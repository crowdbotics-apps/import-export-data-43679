...
## Project Structure
    ...
    ├── import_export_data_43679  # Django project configurations
...
1. Clone this repo and `cd import_export_data_43679`
...
2. Clone this repo and `cd import_export_data_43679`
